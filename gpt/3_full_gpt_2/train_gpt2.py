...
class GPT(nn.Module):
    ...
    def _init_weights(self, module):
        if isinstance(module, nn.Linear):
            ...
            torch.nn.init.normal_(module.weight, mean=0.0, std=std) # should have let this scale with fan-in for faster convergence
...
if __name__ == "__main__":
    ...
    for step in range(max_steps):
        ...
        print(f"step: {step:4d} | loss: {loss.item():.6} | lr: {lr:.4e} | norm: {norm:.4f} | dt: {dt:.2f}ms | tok/sec: {tokens_per_sec:.2f}")
